 ...
 * VARIABLES:
 * 
 * 0: Variables are named identifiers bound to a section of code called a scope. Variables are a way to create and store values that we can use throughout the application. 
